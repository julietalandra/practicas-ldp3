...
Este repositorio es mi espacio personal de aprendizaje y práctica para la materia de Laboratorio de Programación 3. Acá voy subiendo los ejercicios, proyectos y código que desarrollo durante la cursada, enfocados en la creación de aplicaciones web con el ecosistema de Microsoft.
...
- **Fundamentos Web:** Manejo de estado, eventos en el servidor (`OnGet`/`OnPost`), y captura de datos desde formularios HTML.
- **Persistencia en Archivos:** Lectura y escritura en el servidor utilizando `StreamWriter` y `StreamReader`.
